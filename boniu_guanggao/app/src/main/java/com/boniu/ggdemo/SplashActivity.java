...
import com.boniu.advertissdk.IStartNext;
import com.boniu.advertissdk.SplashAdManager;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            new SplashAdManager().ShowSplashAd(this,frameLayout,iStartNext);
        }
    }

    private IStartNext iStartNext = new IStartNext() {
        @Override
    ...
    private void checkAndRequestPermission() {
        ...
        if (!(checkSelfPermission(Manifest.permission.WRITE_APN_SETTINGS) == PackageManager.PERMISSION_GRANTED)) {
            lackedPermission.add(Manifest.permission.WRITE_APN_SETTINGS);
        }
